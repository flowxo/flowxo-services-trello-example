...
module.exports = function(options, done) {
  ...
  // API Docs: https://trello.com/docs/api/board/#get-1-boards-board-id-actions
    ...
    if(err) {
      ...
      options.poller(cardIds, 'id', function(err, newCardIds) {
        if(err) {
          ...
          // API Docs: https://trello.com/docs/api/card/index.html#get-1-cards-card-id-or-shortlink
